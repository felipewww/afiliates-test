        ...
        for (let pos of Object.keys(customerTransactionsIndexed)) {
            ...
            for (let t of transactions) {
                dataModel.push({
                    ...
                    upload_id: uploadId,
                    // credit_sale_creator: (t.type === ETransactionType.SALE_CREATOR) ? t.price : null,
                    // credit_commission_received: (t.type === ETransactionType.COMMISSION_RECEIVED) ? t.price : null,
                    // credit_sale_affiliate: (t.type === ETransactionType.SALE_AFFILIATE) ? t.price : null,
                    // debit_commission_paid: (t.type === ETransactionType.COMMISSION_PAID) ? t.price : null,
